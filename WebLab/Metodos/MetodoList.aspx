...
<br />   &nbsp;
		...
		<table width="600px" align="center" class="myTabla">
			<tr>
				...
				<td ><b  class="mytituloTabla">LISTA DE METODOS</b>
                    </td>
			
			<td align="right"> <a href="../Help/Documentos/Métodos.htm" target="_blank"  > <img style="border:none;"  title="Ayuda en linea" alt="Ayuda" src="../App_Themes/default/images/information.png" /></a></td>
			</tr>
			<tr>
				<td colspan="2" >
        ...
        <asp:GridView ID="gvLista" runat="server" AutoGenerateColumns="False" 
            ...
            onrowdatabound="gvLista_RowDataBound" Font-Size="9pt" Width="100%" 
                        EmptyDataText="No hay métodos creados" BorderColor="#3A93D2" 
