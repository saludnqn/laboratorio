...
<asp:Content ID="content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table align="center" class="style10" width="1000px">
        ...
        <tr>
            <td class="mytituloTabla" colspan="3">&nbsp;</td>
            <td class="mytituloTabla" align="right" style="width: 187px" colspan="2">&nbsp;</td>
        </tr>

        <tr>
            <td class="mytituloTabla" colspan="3">REPORTE ESTADISTICO MICROBIOLOGIA<br />
            </td>
        ...
        <tr>
            <td class="myLabelIzquierda" align="left">Análisis:&nbsp; </td>
        ...
        <tr>
            <td class="myLabelIzquierda" align="left">Fecha Desde:</td>
            ...
            <td class="myLabelIzquierda" align="left" colspan="2">Fecha Hasta:</td>
        ...
        <tr>
            <td class="myLabelIzquierda" align="left"
                style="vertical-align: top;">Origen:</td>
        ...
        &nbsp;
                        ...
                        <div id="tab1">
                            ...
                            <table style="width: 100%;">
                                    ...
                                    <td align="left" colspan="2">
                                        <anthem:GridView ID="gvTipoMuestra" runat="server" Font-Bold="True" Font-Size="9pt"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="12 a 23 meses" HeaderText="12 a 23">
                                                    <FooterStyle BackColor="#CC3300" />
                                                    <HeaderStyle BackColor="#CC3300" />
                                                    <ItemStyle Width="5%" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="2 a 4 años" HeaderText="2 a 4">
                                                    <FooterStyle BackColor="#CC3300" />
                                                    <HeaderStyle BackColor="#CC3300" />
                                                    <ItemStyle Width="5%" />
                                                </asp:BoundField>

                                                <asp:BoundField DataField="5 a 9 años" HeaderText="5 a 9">
                                                    <FooterStyle BackColor="#CC3300" />
                                                    <HeaderStyle BackColor="#CC3300" />
                                                    <ItemStyle Width="5%" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="10 a 14 años" HeaderText="10 a 14">
                                                    <FooterStyle BackColor="#CC3300" />
                                                    <HeaderStyle BackColor="#CC3300" />
                                                    <ItemStyle Width="5%" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="15 a 19 años" HeaderText="15 a 19">
                                                    <FooterStyle BackColor="#CC3300" />
                                                    <HeaderStyle BackColor="#CC3300" />
                                                    <ItemStyle Width="5%" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="20 a 24 años" HeaderText="20 a 24">
                                                    <FooterStyle BackColor="#CC3300" />
                                                    <HeaderStyle BackColor="#CC3300" />
                                                    <ItemStyle Width="5%" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="25 a 34 años" HeaderText="25 a 34 ">
                                                    <FooterStyle BackColor="#CC3300" />
                                                    <HeaderStyle BackColor="#CC3300" />
                                                    <ItemStyle Width="5%" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="35 a 44 años" HeaderText="35 a 44">
                                                    <FooterStyle BackColor="#CC3300" />
                                                    <HeaderStyle BackColor="#CC3300" />
                                                    <ItemStyle Width="5%" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="45 a 54 años" HeaderText="45 a 54">
                                                    <FooterStyle BackColor="#CC3300" />
                                                    <HeaderStyle BackColor="#CC3300" />
                                                    <ItemStyle Width="5%" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="55 a 64 años" HeaderText="55 a 64">
                                                    <FooterStyle BackColor="#CC3300" />
                                                    <HeaderStyle BackColor="#CC3300" />
                                                    <ItemStyle Width="5%" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="65 a 74 años" HeaderText="65 a 74">
                                                    <FooterStyle BackColor="#CC3300" />
                                                    <HeaderStyle BackColor="#CC3300" />
                                                    <ItemStyle Width="5%" />
                                                </asp:BoundField>
                                ...
                                <tr>
                                    <td align="right" class="myLabelIzquierda" colspan="2">Exportar a Excel
                       ...
                       OnClientClick="verGrafico(); return false;"                       />
                                    ...
                                    <td align="right" class="myLabelIzquierda">Exportar lista de Pacientes
                                ...
                                <tr>
                                    ...
                                    <td align="left" colspan="2">
                                        <table style="width: 100%;" align="left">
                                            <tr>
                                                <td class="mytituloGris" colspan="5">Filtros Adicionales</td>
                                            </tr>
                                            <tr>
        ...
        <tr>
            <td align="right" class="myLabelIzquierda" colspan="2">Exportar Detalle de Pacientes
        ...
        <tr>
            <td align="left" class="myLabelIzquierda" colspan="2">&nbsp;</td>
        </tr>
        <tr>
            <td align="left" colspan="2">
                       ...
                       <div id="tab3">
                           <table style="width: 100%;">
                                   ...
                                   <td align="left" colspan="2">
                                       <table style="width: 100%;">
                                           ...
                                           <tr>
                                               ...
                                               <td class="myLabelIzquierda">Aislamiento:</td>
                                               <td class="myLabelIzquierda">
                               ...
                               <tr>
                                   ...
                                   <td align="right" class="myLabelIzquierda">Exportar a Excel
                               ...
                               <tr>
                                   <td align="right" colspan="2" class="myLabelIzquierda">Exportar detalle de pacientes
    ...
    <div id="tab4">
        <table style="width: 100%;">
            ...
            <tr>
                <td align="left">Resultados Predefinidos
            ...
            <tr>
                <td align="right" class="myLabelIzquierda">Exportar Detalle de Pacientes
