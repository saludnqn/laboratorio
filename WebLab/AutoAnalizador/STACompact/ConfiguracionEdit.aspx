<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConfiguracionEdit.aspx.cs" Inherits="WebLab.AutoAnalizador.STACompact.ConfiguracionEdit" MasterPageFile="~/Site1.Master" %>
...
<tr>
						<td class="mytituloGris" colspan="2" >
                                    <img src="../../App_Themes/default/images/logo_stago.jpg" /> <br />Configuración LIS - EQUIPO STA-Compact<hr /></td>
					...
					<tr>
						...
						<div style="border: 1px solid #999999; height: 600px; width:610px; overflow: scroll;">
                                <asp:GridView ID="gvLista" runat="server" AutoGenerateColumns="False" Width="590px" 
                                    DataKeyNames="idSTACompactItem" onrowcommand="gvLista_RowCommand" 
                                    onrowdatabound="gvLista_RowDataBound" 
                                    EmptyDataText="No se configuraron prácticas para el equipo">
                                    <Columns>
                                        <asp:BoundField DataField="codigo" HeaderText="Codigo" />
                                        <asp:BoundField DataField="nombre" HeaderText="Nombre" />
                                        <asp:BoundField DataField="idSTACompac" HeaderText="ID en Equipo" />
