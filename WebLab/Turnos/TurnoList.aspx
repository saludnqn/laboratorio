      ...
      <table style="width:950px;" align="center" class="myTabla">
        <tr>
                ...
                <table style="border: 1px double #3A93D2; background-color: #F3F3F3;">
                    ...
                    <tr>
                        <td align="center">
                            &nbsp;</td>
                        <td align="center">
                            <asp:DropDownList ID="ddlTipoServicio" runat="server" CssClass="myList"  Width="150px" 
                                onselectedindexchanged="ddlTipoServicio_SelectedIndexChanged"                                 AutoPostBack="True">
                            </asp:DropDownList>
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <asp:DropDownList ID="ddlItem" runat="server" AutoPostBack="True" 
                                CssClass="myList" onselectedindexchanged="ddlTipoServicio_SelectedIndexChanged"    Width="200px">
                            </asp:DropDownList>
                            <asp:ImageButton ID="imgCalendarioView" runat="server" Visible="false"  ImageUrl="~/App_Themes/default/images/zoom.png" 
                                ToolTip="Próximos días habilitados" />
                        </td>
                        <td align="center">
                            &nbsp;</td>
            ...
            <td class="myLabelIzquierda" colspan="2">
                ...
                <td class="myLabelIzquierda" align="right" colspan="2">
                  <table >
            ...
            <tr>
            <td colspan="4" ><asp:Label ID="lblUltimoProtocolo" runat="server"  CssClass="myButtonRojo" Font-Size="12pt"></asp:Label> 
            </td>
