...
namespace WebLab.Informes {
    ...
    public class Resultado : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "WebLab.Informes.Resultado.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedResultado : Component, ICachedReport {
        
        public CachedResultado() {
        }
