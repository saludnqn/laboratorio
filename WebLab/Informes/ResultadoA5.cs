...
namespace WebLab.Informes {
    ...
    public class ResultadoA5 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "WebLab.Informes.ResultadoA5.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedResultadoA5 : Component, ICachedReport {
        
        public CachedResultadoA5() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            ResultadoA5 rpt = new ResultadoA5();
            rpt.Site = this.Site;
            return rpt;
        }
