...
namespace WebLab.Informes {
    ...
    public class ResultadoPesquisa : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "WebLab.Informes.ResultadoPesquisa.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedResultadoPesquisa : Component, ICachedReport {
        
        public CachedResultadoPesquisa() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            ResultadoPesquisa rpt = new ResultadoPesquisa();
            rpt.Site = this.Site;
            return rpt;
        }
