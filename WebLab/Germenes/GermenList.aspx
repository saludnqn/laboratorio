   ...
   <br />   &nbsp;
		...
		<table width="600px" align="center" class="myTabla">
			<tr>
				...
				<td ><b  class="mytituloTabla">LISTA DE MICROORGANISMOS</b>
                    </td>
			
			<td align="right"> 
			<a href="../Help/Documentos/Microorganismo.htm" target="_blank"  > <img style="border:none;" alt="Ayuda"  title="Ayuda en linea" src="../App_Themes/default/images/information.png" /></a>
			</td>
			</tr>
			<tr>
				<td colspan="2" >
    ...
    <div align="left" style="overflow:scroll;overflow-x:hidden; height: 600px;">
        <asp:GridView ID="gvLista" runat="server" AutoGenerateColumns="False" 
            ...
            onrowdatabound="gvLista_RowDataBound" Font-Size="9pt" Width="97%" 
                        EmptyDataText="No hay microorganismos creados" BorderColor="#3A93D2" 
