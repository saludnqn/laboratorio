...
<asp:Content ID="content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">  
    <br />   &nbsp;
		...
		<table width="400px" align="center" class="myTabla">
			<tr>
			
				<td ><b  class="mytituloTabla">LISTA DE UNIDAD DE MEDIDA</b>
                    </td>
			
			<td   align="right">
                    <a href="../Help/Documentos/Unidad de Medida.htm" target="_blank"  > <img style="border:none;" alt="Ayuda"  title="Ayuda en linea" src="../App_Themes/default/images/information.png" /></a></td>
			</tr>
			<tr>
				<td colspan="2" >
        ...
        <asp:GridView ID="gvLista" runat="server" AutoGenerateColumns="False"  
            ...
            onrowdatabound="gvLista_RowDataBound" Font-Size="9pt" Width="100%" 
                        EmptyDataText="No hay unidades de medida creadas" BorderColor="#3A93D2" 
