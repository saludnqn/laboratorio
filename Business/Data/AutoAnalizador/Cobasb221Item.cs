...
namespace Business.Data.AutoAnalizador
{
	...
	/// </summary>
	[Serializable]
	public sealed class Cobasb221Item: Business.BaseDataAccess
	{

		#region Private Members
		private bool m_isChanged;

		private int m_idcobasb221item; 
		private string m_idcobas; 
		...
		/// default constructor
		/// </summary>
		public Cobasb221Item()
		{
			m_idcobasb221item = 0; 
			m_idcobas = String.Empty; 
			m_iditem = 0; 
			m_habilitado = false; 
		}
		...
		/// 
		/// </summary>
		public int IdCobasb221Item
		{
			get { return m_idcobasb221item; }
			set
			{
				m_isChanged |= ( m_idcobasb221item != value ); 
				m_idcobasb221item = value;
			}
		...
		/// 
		/// </summary>
		public string IdCobas
		{
			get { return m_idcobas; }
			...
			{	
				...
				m_isChanged |= (m_idcobas != value); m_idcobas = value;
			}
		}
