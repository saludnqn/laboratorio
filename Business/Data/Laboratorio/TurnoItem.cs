...
namespace Business.Data.Laboratorio
{
	...
	/// </summary>
	[Serializable]
    public sealed class TurnoItem : Business.BaseDataAccess
	{

		#region Private Members
		private bool m_isChanged;

		private int m_idturnoitem; 
		...
		/// 
		/// </summary>
		public int IdTurnoItem
		{
			get { return m_idturnoitem; }
			set
			{
				m_isChanged |= ( m_idturnoitem != value ); 
				m_idturnoitem = value;
			}
